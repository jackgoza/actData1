...
Will accept user input via GUI menu selection
...
int main(){
	// set console title
	SetConsoleTitle(TEXT("CS303, Project1A, Assignment Menu BY:J.Goza, J.Ford,S. Peery"));
	...
	// let user know that program is working
	cout << "Compiling data, please wait....." << endl << endl;
